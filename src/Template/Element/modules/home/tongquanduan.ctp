<div class="block project-overview-block" id="project-overview">
    <div class="container">
        <h1>Tổng quan dự án</h1>
        <div class="numbers-container">
            <div order="1" class="single-number-board">
                <div class="board-content board-text">
                    DIỆN TÍCH KHU ĐẤT
                </div>
                <div class="board-content board-number">
                    313554m<sup>2</sup>
                </div>
            </div>
            <div order="2" class="single-number-board">
                <div class="board-content board-text">
                    MẬT ĐỘ XÂY DỰNG
                </div>
                <div class="board-content board-number">
            ...
            <div order="3" class="single-number-board">
                <div class="board-content board-text">
                    SỐ LƯỢNG LÔ NỀN
                </div>
                <div class="board-content board-number">
            ...
            <div order="4" class="single-number-board">
                <div class="board-content board-text">
                    QUY MÔ DÂN SỐ
                </div>
                <div class="board-content board-number">
        ...
        <div class="tabpane-container" id="area-links">
            ...
            <div class="tab-content">
                <div data-id="1" class="tab-pane fade show active" id="project-overview-1" role="tabpanel"
                ...
                <div data-id="2" class="tab-pane fade" id="project-overview-2" role="tabpanel" aria-labelledby="project-overview-2-tab">
                    <img class="img-map img-fluid open-image-popup" data-zoomable alt="map" src="<?= $this->request->webroot ?>images/map2.jpg"/>
                </div>
            </div>
        </div>
    </div>
