        ...
        <div class="col-md-12">
            ...
            <div class="portlet box grey-cascade">
                ...
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        <div><?php echo $this->Form->input('title', ['class' => 'form-control', 'placeholder' => 'Title']); ?>
                        </div>
                        <div id="group-image">
                        ...
                        <div>
                            <?php echo $this->Form->input('content', ['class' => 'form-control', 'placeholder' => 'Content', 'id' => 'content']); ?>
                        </div>
                        <div>
                            <?php echo $this->Form->input('appear', ['class' => 'form-control', 'placeholder' => 'Appear']); ?>
                        </div>
                    </div>
